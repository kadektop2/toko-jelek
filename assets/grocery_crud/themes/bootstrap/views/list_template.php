...
function action_selected(act)
    {
        ...
        if(act == 'delete'){
            //send data to delete
            $.post(base_url + 'customer/delete_selection', { selection: list }, function(data) {
                alert('Successfully Deleted');
            });
        } else if(act == 'export'){
            //send data to export
            $.post(base_url + 'customer/export_selection', { selection: list }, function(data) {
                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            ...
                            <div class="floatL t5">
                                <!-- <button style="color:#FFF !important;" class="btn btn-default btn-danger" onclick="action_selected('delete');">Delete Selected</button> -->
                            </div>
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-default btn-primary" style="color:#FFF !important;" href="<?php echo $add_url?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject?></a>
                                </div>
                            <?php } ?>
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
